...
Call log:
  - waiting for getByRole('link', { name: 'Indigo Primary MPL' })
    - waiting for" https://preprod.origamirisk.com/Origami/Proposals/NewApplication" navigation to finish...
    - navigated to "https://preprod.origamirisk.com/Origami/Proposals/NewApplication"
    - locator resolved to <a href="/Origami/Proposals/NewApplication?PolicySetID=16">Indigo Primary MPL</a>
  - attempting click action
    ...
    at C:\Users\sbasheer\Playwrightautomation\tests\submitquote.spec.js:20:64
```
...
- main:
  - heading "Select Rating Program" [level=1]
  - list:
    - listitem:
      - button "Cancel"
  - heading "Active Rating Programs" [level=4]
  - link "IA MPL":
    - /url: /Origami/Proposals/NewApplication?PolicySetID=24
  - link "Indigo Excess MPL":
    - /url: /Origami/Proposals/NewApplication?PolicySetID=17
  - link "Indigo Primary MPL":
    - /url: /Origami/Proposals/NewApplication?PolicySetID=16
```
