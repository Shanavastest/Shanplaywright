...
```
Error: locator.click: Unsupported token "@alt" while parsing css selector "button[@alt='MemberID']". Did you mean to CSS.escape it?
Call log:
  - waiting for button[@alt='MemberID']

    at C:\Users\sbasheer\Playwrightautomation\tests\submitquote.spec.js:27:48
```
...
> 27 |  await page.locator("button[@alt='MemberID']").click();
     |                                                ^ Error: locator.click: Unsupported token "@alt" while parsing css selector "button[@alt='MemberID']". Did you mean to CSS.escape it?
  28 |
