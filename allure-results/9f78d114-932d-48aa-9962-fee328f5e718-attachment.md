...
Call log:
  - waiting for getByLabel('Duplicate Proposal Override')

    at C:\Users\sbasheer\Playwrightautomation\tests\submitquote.spec.js:37:56
```
...
- main:
  ...
  - list:
    ...
    - listitem:
      - button "Cancel"
  - status: " Please correct the following errors: Insured: A value is required. Agency: A value is required. Agent: A value is required."
