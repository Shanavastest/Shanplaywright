...
Call log:
  - waiting for locator('button[alt=\'MemberID\']')
    - locator resolved to <button tabindex="0" type="button" alt="MemberID" title="Click to lookup value" class="toolTipIconDefaultColor toolTipIconDefault lookupInputIcon lookupImage" href="/Origami/Members?popup=True&requiredOnLookup=&_inactivecheckdate=00010101&origamiTitle=Insured">…</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable

    at C:\Users\sbasheer\Playwrightautomation\tests\submitquote.spec.js:27:13
```
