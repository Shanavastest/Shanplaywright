...
Call log:
  - attempting click action
    ...
    at HomePage.addProductToCart (C:\Users\sbasheer\Playwrightautomation\tests\pages\Homepage.js:15:19)
    at C:\Users\sbasheer\Playwrightautomation\tests\Pomtest.spec.js:18:5
```
...
> 15 |     await product.click();
  ...
  23 |     }
  24 | })
  25 | await this.page.locator(this.addToCartbtn).click();
  26 |
  27 | }
  28 |
  29 |  async gotoCart () {
